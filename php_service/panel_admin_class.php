                    ...
                    <table class="table">
                        ...
                        if(isset($query_c_id) || isset($query_c_name) || isset($query_c_credit) || isset($query_c_type))
                        {
                            ...
                            foreach($rs as $r) {
                                ...
                                echo "<td>";
                                echo "<a href=\"$server_addrr/php1/php_service/panel_admin_class.php?choose_class_status=yes&choose_classid=$temp&choose_classname=$temp_class_name#query_extra\" class=\"button primary\">修改</a>";
                                echo "</td>";
                                $i++;
                                echo "</tr>";
                            }
...
VIEW;
                    ...
                    $rs = $qcsql->queryData(5);
                        foreach($rs as $r) {
                            ...
                            $temp2 = $j[$i-4];
                            echo "<td>";
                            echo "<a href=\"$server_addrr/php1/php_service/panel_admin_class.php?choose_class_status=yes&del_stid=$temp&del_stname=$temp2&choose_classid=$choose_classid&choose_classname=$choose_classname#query_extra\" class=\"button primary\">删除</a>";
                            echo "</td>";
                            $i++;
                            echo "</tr>";
                        }
...
FORM;
                    ...
                    <ul class="actions">
                        ...
                        <li><input type="reset" value="清除" /></li>
INPUT;
                    echo "<li><a href=\"$server_addrr/php1/php_service/panel_admin_class.php?delclassid=$choose_classid\" class=\"button primary\">删除课程</a></li>";
                    echo "</ul>";
                    echo "</form>";
                    echo "</div>";
                    echo "</div>";
