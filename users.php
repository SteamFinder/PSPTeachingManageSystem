...
<body>
    ...
    <main>
        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
            <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
                <div style="text-align: center;">
                    <img src="http://202.197.75.107:8080/public/assets/csulogo.png" style="width:48px;height:48px;"
                        onclick="config()">
                </div>
                <span class="fs-4">管理面板</span>
            </a>
            <hr>
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item">
                    <a href="http://202.197.75.107:8080/home.php" class="nav-link link-dark">
                ...
                <li class="mb-1">
                    ...
                    <div class="collapse" id="dashboard-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                            ...
                            <li><a href="javascript:void(document.getElementById('ifr').src='http://202.197.75.107:8080/public/php_service/panel_admin_user.php#one')"
                                    class="link-dark rounded">管理与查询</a></li>
                            <li><a href="javascript:void(document.getElementById('ifr').src='http://202.197.75.107:8080/public/php_service/panel_admin_user.php#add_user_result')"
                                    class="link-dark rounded">添加用户</a></li>
                        </ul>
                    </div>
                </li>
                <li>
        ...
        <div class="iframe-container">
            <!--面板实际地址-->
            <iframe src="http://202.197.75.107:8080/public/php_service/panel_admin_user.php" id="ifr"></iframe>
        </div>
        <!--内容结束-->
    </main>
